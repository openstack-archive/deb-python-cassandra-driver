...
class ClusterTest(unittest.TestCase):
    @unittest.skipIf("2" in sys.version, "Not running tests for python2, version {0}".format(sys.version))
    def test_python2(self):
        assert 1 + 1 == 2

    @unittest.skipIf("3" in sys.version, "Not running tests for python3, version {0}".format(sys.version))
