...
notbigclockgranularity = unittest.skipUnless(not "Windows" in platform.system() or "async" in EVENT_LOOP_MANAGER,
                                             "This test is not sutiables for ennvironments with big clock granularity")
